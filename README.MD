...
- Applications that use this package are encouraged to design [Normalized State](https://redux.js.org/recipes/structuring-reducers/normalizing-state-shape) trees.
...
//or
const [isRunning, showRunningWhile] = useLoadingState({ defer: 100, minLoadingTime: 250 });
